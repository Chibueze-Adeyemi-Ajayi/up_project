...
// index arrow function really should be a function that returns a promise that resolves
const Index = (props) => { 
    ...
    return (
        <section className='w-full h-full bg-white flex flex-col space-y-2'>
            <Header screen_func={props.screen_func} connect_wallet_func={connect_wallet_func}/>
